...
if [ -f $data/segments ]; then
  ...
  $cmd JOB=1:$nj $logdir/make_mfcc_${name}.JOB.log \
    ...
    compute-mfcc-feats $vtln_opts --sample-frequency=8000 --verbose=2 --config=$mfcc_config ark:- ark:- \| \
  ...
  $cmd JOB=1:$nj $logdir/make_mfcc_${name}.JOB.log \
    compute-mfcc-feats  $vtln_opts --sample-frequency=8000 --verbose=2 --config=$mfcc_config \
